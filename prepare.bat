...
:RunBuildScript
	@echo %DotNetFramework%\MSBuild.exe build.proj /target:PrepareBuild /fl /flp:LogFile=%TemporaryLog%
	%DotNetFramework%\MSBuild.exe build.proj /target:PrepareBuild /fl /flp:LogFile=%TemporaryLog%
