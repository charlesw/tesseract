...
namespace Tesseract.Interop
{
    ...
    public interface ITessApiSignatures
    {
        ...
        bool BaseAPIProcessPages(HandleRef handle, [MarshalAs(UnmanagedType.LPStr)]string filename, [MarshalAs(UnmanagedType.LPStr)]string retry_config, int timeout_millisec, HandleRef renderer);
        ...
        bool ResultRendererBeginDocument(HandleRef renderer, string title);
        ...
        bool ResultRendererEndDocument(HandleRef renderer);
