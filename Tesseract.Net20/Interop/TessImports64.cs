...
{
	internal static class TessImports64
	{
		internal static TesseractImplementation Initialize()
		{
			WindowsLibraryLoader.Instance.LoadLibrary(Constants.TesseractDllName64);
		...
		[DllImport(Constants.TesseractDllName64, CallingConvention = CallingConvention.Cdecl, EntryPoint="TessVersion")]
		internal static extern string GetVersion();
		
		[DllImport(Constants.TesseractDllName64, CallingConvention = CallingConvention.Cdecl, EntryPoint="TessDeleteText")]
		internal static extern void DeleteText(IntPtr textPtr);
				
		[DllImport(Constants.TesseractDllName64, CallingConvention = CallingConvention.Cdecl, EntryPoint="TessDeleteTextArray")]
		internal static extern void DeleteTextArray(IntPtr arr);		
		
		[DllImport(Constants.TesseractDllName64, CallingConvention = CallingConvention.Cdecl, EntryPoint="TessDeleteIntArray")]
		internal static extern void DeleteIntArray(IntPtr arr);		
		
		[DllImport(Constants.TesseractDllName64, CallingConvention = CallingConvention.Cdecl, EntryPoint="TessDeleteBlockList")]
		internal static extern void DeleteBlockList(IntPtr arr);
		
		[DllImport(Constants.TesseractDllName64, CallingConvention = CallingConvention.Cdecl, EntryPoint="TessBaseAPICreate")]
		internal static extern IntPtr BaseApiCreate();

		[DllImport(Constants.TesseractDllName64, CallingConvention = CallingConvention.Cdecl, EntryPoint="TessBaseAPIDelete")]
		internal static extern void BaseApiDelete(IntPtr ptr);
		
		[DllImport(Constants.TesseractDllName64, CallingConvention = CallingConvention.Cdecl, EntryPoint="TessBaseAPIInit1")]
		...
		[DllImport(Constants.TesseractDllName64, CallingConvention = CallingConvention.Cdecl, EntryPoint="TessBaseAPISetVariable")]
		internal static extern int BaseApiSetVariable(IntPtr handle, string name, string value);		
		
		[DllImport(Constants.TesseractDllName64, CallingConvention = CallingConvention.Cdecl, EntryPoint="TessBaseAPISetDebugVariable")]
		internal static extern int BaseApiSetDebugVariable(IntPtr handle, string name, string value);		
				
		[DllImport(Constants.TesseractDllName64, CallingConvention = CallingConvention.Cdecl, EntryPoint="TessBaseAPIGetIntVariable")]
		internal static extern int BaseApiGetIntVariable(IntPtr handle, string name, out int value);
		
		[DllImport(Constants.TesseractDllName64, CallingConvention = CallingConvention.Cdecl, EntryPoint="TessBaseAPIGetBoolVariable")]
		internal static extern int BaseApiGetBoolVariable(IntPtr handle, string name, out int value);
		
		[DllImport(Constants.TesseractDllName64, CallingConvention = CallingConvention.Cdecl, EntryPoint="TessBaseAPIGetDoubleVariable")]
		internal static extern int BaseApiGetDoubleVariable(IntPtr handle, string name, out double value);
		
		[DllImport(Constants.TesseractDllName64, CallingConvention = CallingConvention.Cdecl, EntryPoint="TessBaseAPIGetStringVariable")]
		...
		[DllImport(Constants.TesseractDllName64, CallingConvention = CallingConvention.Cdecl, EntryPoint="TessBaseAPISetPageSegMode")]
        internal static extern void BaseAPISetPageSegMode(IntPtr handle, PageSegMode mode);

        [DllImport(Constants.TesseractDllName64, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessBaseAPIGetPageSegMode")]
        internal static extern PageSegMode BaseAPIGetPageSegMode(IntPtr handle);

        [DllImport(Constants.TesseractDllName64, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessBaseAPISetImage2")]
        internal static extern void BaseApiSetImage(IntPtr handle, IntPtr pixHandle);

        [DllImport(Constants.TesseractDllName64, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessBaseAPISetRectangle")]
        internal static extern void  BaseApiSetRectangle(IntPtr handle, int left, int top, int width, int height);
                
        [DllImport(Constants.TesseractDllName64, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessBaseAPIRecognize")]
        internal static extern int BaseApiRecognize(IntPtr handle, IntPtr monitor);
        
        [DllImport(Constants.TesseractDllName64, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessBaseAPIAnalyseLayout")]
        internal static extern IntPtr BaseAPIAnalyseLayout(IntPtr handle);

        [DllImport(Constants.TesseractDllName64, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessBaseAPIGetIterator")]
        internal static extern IntPtr BaseApiGetIterator(IntPtr handle);

        [DllImport(Constants.TesseractDllName64, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessBaseAPIGetUTF8Text")]
        internal static extern IntPtr BaseAPIGetUTF8TextInternal(IntPtr handle);

        [DllImport(Constants.TesseractDllName64, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessBaseAPIGetHOCRText")]
        internal static extern IntPtr BaseAPIGetHOCRTextInternal(IntPtr handle, int pageNum);

        [DllImport(Constants.TesseractDllName64, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessBaseAPIMeanTextConf")]
        internal static extern int BaseAPIMeanTextConf(IntPtr handle);
               
        [DllImport(Constants.TesseractDllName64, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessBaseAPIClear")]
        internal static extern void BaseAPIClear(IntPtr handle);

        [DllImport(Constants.TesseractDllName64, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessResultIteratorDelete")]
        internal static extern void ResultIteratorDelete(IntPtr handle);

        [DllImport(Constants.TesseractDllName64, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessResultIteratorCopy")]
        internal static extern IntPtr ResultIteratorCopy(IntPtr handle);

        [DllImport(Constants.TesseractDllName64, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessResultIteratorGetPageIterator")]
        internal static extern IntPtr ResultIteratorGetPageIterator(IntPtr handle);

        [DllImport(Constants.TesseractDllName64, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessResultIteratorGetUTF8Text")]
        internal static extern IntPtr ResultIteratorGetUTF8TextInternal(IntPtr handle, PageIteratorLevel level);

        [DllImport(Constants.TesseractDllName64, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessResultIteratorConfidence")]
        internal static extern float ResultIteratorGetConfidence(IntPtr handle, PageIteratorLevel level);

        [DllImport(Constants.TesseractDllName64, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessPageIteratorDelete")]
        internal static extern void PageIteratorDelete(IntPtr handle);

        [DllImport(Constants.TesseractDllName64, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessPageIteratorCopy")]
        internal static extern IntPtr PageIteratorCopy(IntPtr handle);

        [DllImport(Constants.TesseractDllName64, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessPageIteratorBegin")]
        internal static extern void PageIteratorBegin(IntPtr handle);

        [DllImport(Constants.TesseractDllName64, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessPageIteratorNext")]
        internal static extern int PageIteratorNext(IntPtr handle, PageIteratorLevel level);

        [DllImport(Constants.TesseractDllName64, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessPageIteratorIsAtBeginningOf")]
        internal static extern int PageIteratorIsAtBeginningOf(IntPtr handle, PageIteratorLevel level);

        [DllImport(Constants.TesseractDllName64, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessPageIteratorIsAtFinalElement")]
        internal static extern int PageIteratorIsAtFinalElement(IntPtr handle, PageIteratorLevel level, PageIteratorLevel element);

        [DllImport(Constants.TesseractDllName64, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessPageIteratorBoundingBox")]
        ...
        [DllImport(Constants.TesseractDllName64, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessPageIteratorBlockType")]
        internal static extern PolyBlockType PageIteratorBlockType(IntPtr handle);

        [DllImport(Constants.TesseractDllName64, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessPageIteratorGetBinaryImage")]
        internal static extern IntPtr PageIteratorGetBinaryImage(IntPtr handle, PageIteratorLevel level);

        [DllImport(Constants.TesseractDllName64, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessPageIteratorGetImage")]
        ...
        [DllImport(Constants.TesseractDllName64, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessPageIteratorBaseline")]
        ...
        [DllImport(Constants.TesseractDllName64, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessPageIteratorOrientation")]
